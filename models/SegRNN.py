...
class SegRNN(nn.Module):
    ...
    def encoder(self, x):
        ...
        y_target = y[:, self.target_idx:self.target_idx+1, :]  # 形状 [B, 1, pred_len]
        seq_last_target = seq_last[:, :, -self.pred_len:]  # 形状 [B, 1, pred_len]
        # permute and denorm
        y_target = y_target.permute(0, 2, 1) + seq_last_target.permute(0, 2, 1)
        return y_target
