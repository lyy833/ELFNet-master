...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_epochs1', type=int, default=10, help='Number of epochs for pretrain ELFNet using contrasitive learning')
    parser.add_argument('--train_epochs2', type=int, default=20 ,help='Number of epochs for pretrain ELFNet using supervised learning')
